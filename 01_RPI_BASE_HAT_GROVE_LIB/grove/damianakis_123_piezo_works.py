...
""")
    ...
    with open('/home/pi/RPI_BASE_HAT_GROVE_LIB/grove/project/piezo.dat','w') as f:
            pass
        
    
    with open('/home/pi/RPI_BASE_HAT_GROVE_LIB/grove/project/emg.dat','w') as f:
            pass
    ...
    while True:
        ...
        with open('/tmp/2', 'a') as f:
            value = adc.read_voltage(6)
            print(value)
            if (value > 90 & value <2500):
                print(value)
                f.write('%d \n' % value)
                time.sleep(1)
